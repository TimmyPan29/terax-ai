...
let
  ...
  srcMap = {
    x86_64-linux = fetchurl {
      url = "https://github.com/TimmyPan29/terax-ai/releases/download/v${version}/Terax_${version}_amd64.deb";
      hash = sources.hashes.x86_64-linux;
    };
    aarch64-darwin = fetchurl {
      url = "https://github.com/TimmyPan29/terax-ai/releases/download/v${version}/Terax_${version}_aarch64.app.tar.gz";
